...
export default function Cart() {
  ...
  async function fetchCartProducts() {
    await axios.get("https://e-commerce-application-o9uz.onrender.com/api/cart", {
  ...
  async function removeFromCart(productId) {
    try {
      await axios.delete(`https://e-commerce-application-o9uz.onrender.com/api/cart/remove/${productId}`, {
        headers: { Authorization: `Bearer ${user.token}` }
      })
        .then((res) => {
