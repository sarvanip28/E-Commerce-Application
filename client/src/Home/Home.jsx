...
export default function Home() {
    ...
    async function fetchProducts() {
        await axios.get("https://e-commerce-application-o9uz.onrender.com/api/product")
            .then((res) => {
                console.log(res)
    ...
    async function addCart(productId) {
        ...
        try {
            await axios.post("https://e-commerce-application-o9uz.onrender.com/api/cart/add", { productId }, {
